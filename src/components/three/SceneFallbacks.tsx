...
const TAGS = [
  ...
  { label: "AI", color: "#7C3AED", angle: -30 },
  { label: "GEO", color: "#06B6D4", angle: 30 },
  { label: "AEO", color: "#8B5CF6", angle: 90 },
  ...
  return (
    <div className="relative flex h-[380px] w-full items-center justify-center overflow-hidden md:h-[460px]">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 h-40 w-40 animate-blob rounded-full bg-purple-300/30 blur-3xl [animation-delay:2s]" />
      ...
      <div className="relative h-64 w-64 sm:h-72 sm:w-72">
        ...
        <motion.div
          ...
          className="absolute inset-4 rounded-full border border-dashed border-purple-400/50"
        />
        <motion.div
          animate={{ rotate: 360 }}
        ...
        <motion.div
          ...
          className="absolute inset-[28%] flex items-center justify-center rounded-full bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 shadow-[0_0_40px_rgba(37,99,235,0.45)]"
        >
  ...
  return (
    <div className="relative mx-auto flex h-[360px] w-full max-w-lg items-center justify-center md:h-[420px]">
      <div className="relative h-56 w-56 animate-float">
        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-100/80 via-purple-100/60 to-cyan-100/80 blur-sm" />
